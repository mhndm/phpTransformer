...
if ($OpenRegister == "1") {
    if (isset($_POST['SignUp'])) {
        ...
        if (isset($_POST['UserMail'])) {
            ...
            if (check_email($UserMail)) {
                $UserMailErr = '<img border="0" alt="Ok" title="Ok" src="Programs/account/images/ok.gif"/>';
            } else {
                $UserMailErr = '<a href="javascript:void(0)" title="' . (UserMailErrDesk) . '">'
                        . '<img border="0" alt="No" title="" src="Programs/account/images/no.gif"/></a> ';
                $Err = true;
                //echo "err UserMail";
            }//end if
        } else {
        ...
        if (isset($_POST['SignUp'])) {
            ...
            //$Err = true;
            //}
            if (!isset($_SESSION['op_result']) || $_SESSION['op_result'] != $_POST["pt_recaptcha_response_field"]) {
                unset($_SESSION['op_result']);
                $CaptchaErr = '<a href="javascript:void(0)" title="' . CaptchaErr . '">'
                        . '<img border="0" alt="No" title="" src="Programs/account/images/no.gif"/></a> ';
                $Err = true;
            }
        }
        if ($Err) {
            ...
            if (isset($_POST['SignUp'])) {
                ...
                if (function_exists("news_notification")) {
                    news_notification($UserId);
                }
            }//end if  
            //sign in
            /*
