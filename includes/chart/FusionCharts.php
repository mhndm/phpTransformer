...
$HTML_chart = <<<HTMLCHART
	...
	<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"  width="$chartWidth" height="$chartHeight" id="$chartId">
		<param name="allowScriptAccess" value="always" />
		<param name="movie" value='$chartSWF' />		
		<param name="FlashVars" value='$strFlashVars' />
		<param name="quality" value="high" />
		<embed src="$chartSWF" FlashVars='$strFlashVars' quality="high" width="$chartWidth" height="$chartHeight" name="$chartId" allowScriptAccess="always" type="application/x-shockwave-flash"  />
	</object>
