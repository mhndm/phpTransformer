...
function get_news_by_date($user_infos = array("t" => "","l" => "","u" => "","m" => "","n" => "","d" => ""))
    {
        ...
        $latest_news_arr[] = array("type" => "category","id" => '903930' ,"title" => api_last_news);
