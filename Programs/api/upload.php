...
if(isset($_FILES['file']) && $_FILES['file']['error'] == 0)
	...
	if(move_uploaded_file($_FILES['file']['tmp_name'], "../../uploads/gallery/Albums/$year/$day-$month-$year/".$hashed_uploaded_file_name))
            {
                $file_hashed_path = "../../uploads/gallery/Albums/$year/$day-$month-$year/".$hashed_uploaded_file_name;
                if (is_file('../../jkhk/Programs/gallery/admin/img/water.png'))
                    {
