...
qq.extend(qq.FineUploader.prototype, {
    ...
    _onComplete: function(id, name, result, xhr){
        ...
        if (result.success) { 
            var file_name = result.uploadName;
            $("#NewsPic").val(file_name);
            $("#MiniNewsPic").html('<img style="max-width:200px; max-height:200px;" src="uploads/news/pics/'+file_name+'" alt="'+file_name+'"/>');
