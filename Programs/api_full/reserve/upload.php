	...
	if(move_uploaded_file($_FILES['upl']['tmp_name'], "../../../uploads/gallery/Albums/$year/$day-$month-$year/".$hashed_uploaded_file_name))
            {
                ...
                create_news_thumbs("../../../uploads/gallery/Albums/$year/$day-$month-$year/".$hashed_uploaded_file_name, 
                                   "../../../uploads/gallery/Albums/$year/$day-$month-$year/".$hashed_uploaded_file_name, 600);
                copy("../../../uploads/gallery/Albums/$year/$day-$month-$year/".$hashed_uploaded_file_name, 
                        "../../../uploads/gallery/Albums/$year/$day-$month-$year/medium/".$hashed_uploaded_file_name);
                create_news_thumbs("../../../uploads/gallery/Albums/$year/$day-$month-$year/".$hashed_uploaded_file_name, 
                        "../../../uploads/gallery/Albums/$year/$day-$month-$year/thumbs/".$hashed_uploaded_file_name, 150);
