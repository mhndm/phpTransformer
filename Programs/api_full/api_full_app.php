        ...
        switch($operation)
            {
                ...
                case 'g_v':
                    {
                        $result_json = json_encode(array("ver" => $current_version,"req" => $critical_update));
                        break;
                    }
    ...
    if($db->dbh->affected_rows > 0)
        {
            ...
            if(count($news_images_arr)>0)//If their is any image uploaded
                ...
                {
                    //Updated in 15/09/2014 at 09:35 am to don't add any default picture to unurgent news in details
