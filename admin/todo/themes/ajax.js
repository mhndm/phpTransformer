function stat_From_messagecenter(program,ThemeName,Yes,No,Lang,edit){
        ...
        if (program.readyState == 4){
            if(program.status == 200){
                ...
                if( key == '1'){
                    ...
                    '<img border="0" src="admin/Themes/'+ThemeName+'/images/dialog_ok.png" width="16" height="16" title="" alt="" />'+Yes+edit;
                }
                else{
                    document.getElementById('msg'+programname).innerHTML = 
    ...
    program.open("POST", "admin/todo/themes/proxy.php");
