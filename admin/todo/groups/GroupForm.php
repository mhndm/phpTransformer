...
<form name="form1" method="post" action=""><table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    ...
    <input class="text" name="GroupName" type="text" value="" size="15" maxlength="15" /><span class="textfieldRequiredMsg">Avalueisrequired</span><span class="textfieldMinCharsMsg">Minimumnumberofcharactersnotmet</span></span>
    </td>
  </tr>
  <tr>
    <td>{GroupDesc} : </td>
    <td><input class="text" name="Desc" type="text" id="Desc" value="" size="50" maxlength="50" /></td>
  </tr>
  <tr>
